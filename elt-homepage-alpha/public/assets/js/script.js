(() => {
  var q = { autoSleep: 120, force3D: "auto", nullTargetWarn: 1, units: { lineHeight: "" } },
    qe = { duration: 0.5, overwrite: !1, delay: 0.75 },
    qt,
    _e = 1e8,
    D = 1 / _e,
    Qt = Math.PI * 2,
...
`,
    ...
    void main() {
        ...
        //edit * 23
        float velocity = clamp(length(uVelocity), 0.9, 1.0);
...
`,
    ...
    const float shadowColorEffect = 0.9375; //edit * 23
...
`,
    br = `            
        ...
        // mix foreground and background,gyeon v.
    ...
    addRipples() {
      (this.ripples = new Xt(this.curtains, document.getElementById("ripples"), {
        ...
        uniforms: {
          ...
          speed: { name: "uSpeed", type: "1f", value: 3.75 },
