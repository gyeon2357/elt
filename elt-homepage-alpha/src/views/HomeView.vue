...
<template>
  ...
  <div id="content" data-namespace="home">
    <section id="intro">
      <h2 id="intro-title">
        <p>ː graphic ¶ editorial ◌ app ° web newmedia ― album ˝ music ℗ poster + movie × brochure ≈ branding ˘ illustration * art @every.little.thing</p>
      </h2>
        ...
        <div data-scroll-section data-scroll-speed="4">
          <div class="main-image-thumb">
            <div class="media-wrapper">
              <div class="plane main-image-plane main-main-image-plane main-gradient not-scroll-trigger">
                <img src="/assets/img/elt-bg-bk.jpg" width="1600" height="900" alt="everylittlething" crossorigin="" />
              </div>
            </div>
          </div>
        </div>
        <div data-scroll-section data-scroll-speed="3">
          <div id="intro-desc">
            <div class="text-plane not-scroll-trigger">
              Every.little.thing we does. And you know the things we does. graphic design lab. hannam-dong office&sup1; &#47; hangang-ro office&sup2; &gt; since
              2012
            </div>
          </div>
        </div>
      ...
      <div id="nav-desc">
        <div class="nav-box"><RouterLink to="/about" class="text-plane text-plane-is-link not-scroll-trigger">More About Us </RouterLink><span>→</span></div>
        <div class="nav-box">
          <RouterLink to="/project/gallery" class="text-plane text-plane-is-link not-scroll-trigger">Explore the project </RouterLink><span>→</span>
        </div>
      </div>
    </section>
    <section id="notice">
      <div id="notice-head">
        <RouterLink to="/notice/" class="out main-title-text text-plane text-plane-is-link not-scroll-trigger">Notice</RouterLink>
      </div>
      <div id="notice-desc">
        <RouterLink to="/notice" target="_blank" class="out main-title-text text-plane text-plane-is-link not-scroll-trigger"
